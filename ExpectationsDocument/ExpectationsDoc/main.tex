...
\item Activated in NED
\item Complete DPSAC background check through eQIP.
\item Get fingerprints recorded (can be done remotely).
\item Get PIV card at NIH secuity office ("Badge").
\item Complete necessary trainings in lab safety, security, and bloodborne pathogens (online or in-person).
\item Complete computational bootcamp. Learn basics of GitHub, R, and python. Get necessary software installed on computer. Get access to storage space and BioWULF server, learn how to submit jobs.
...
There are no specific "working hours" for the lab, but the lab will operate around a 9-to-5 schedule. This means lab meetings, discussion, 1-on-1's, seminars, and trainings will be scheduled between 9AM and 5PM Monday-Friday.
Schedules are sometimes irregular due to workloads, experimental constraints or commitments at home. You can work a schedule that works for you as long as you are productive and you attend the scheduled lab meetings. The lab will not close on weekends, but I do expect you to use your weekends to recharge for the week.
...
\item Write papers. Ideally you should have a something in press twice a year. Reviews, perspectives, collaborations are all fair game, but first author publications are the priority.
...
\item Review and edit manuscripts.
\end{enumerate}
...
\newline
Please note: All communications may be monitored on government devices.
...
The lab website is also currently hosted on GitHub: \href{qveu.github.io/qveu/}{qveu.github.io/qveu/}
